                        ...
                        <div className="grid grid-cols-3 gap-7">
                            {
                                dashboardCards.map((cardsData, index) => (
                                    <div
                                        ...
                                        key={index}
                                        className="flex flex-col p-5 gap-1 border border-mute border-opacity-20 rounded-lg bg-white col-span-1">
                            ...
                            !portalData && <h2 className={`text-mute mt-3`}>
                                {
                                    loading ? (
                                        <div className="flex items-center gap-2 p-3 rounded-lg font-bold cursor-wait w-full">
                                            ...
                                            <span className="text-lg">Please wait for your bids to load, this may take a few minutes</span>
                                        </div>
