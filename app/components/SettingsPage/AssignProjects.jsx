...
export default function AssignProjects() {
    ...
    const sortedPortalList = portalListByState.slice().sort((a, b) => a.portalName.localeCompare(b.portalName));
                                        ...
                                        portalListByState.length != 0 ? (
                                            <>
                                                ...
                                                <select
                                                    ...
                                                    {
                                                        sortedPortalList.map((list, index) => (
                                                            <option key={index} content={list.portalState} value={list.portalName} title={list.portalId}
                                                                className='text-sm h-48 overflow-y-auto min-w-full w-max border-[#BCE0FD] border mt-1 rounded'>{list.portalName}</option>
                                                        ))
                                                    }
                                                </select>
                                            </>
